...
var PeopleCollecion = (function (_Collection) {
  function PeopleCollecion() {
    _classCallCheck(this, PeopleCollecion);

    _get(Object.getPrototypeOf(PeopleCollecion.prototype), 'constructor', this).apply(this, arguments);
  }

  _inherits(PeopleCollecion, _Collection);

  _createClass(PeopleCollecion, [{
    key: 'initialize',
  ...
  return PeopleCollecion;
})(Collection);

module.exports = PeopleCollecion;

},{"../models/person_model":6,"backbone":1}],5:[function(require,module,exports){
'use strict';
...
window.App = {
  ...
  listenToFetch: function listenToFetch() {
    this.collection.on('reset', this.afterFetch.bind(this));
  },

  removeZombieViews: function removeZombieViews() {
    this.childrenViews.map(function (view) {
      return view.remove();
    });
  },

  afterFetch: function afterFetch(models) {
    this.removeZombieViews();
    this.renderViews(models);
  },

  renderViews: function renderViews(models) {
    var _this = this;

    var html = this.collection.map(function (model) {
      var view = new PersonView({ model: model });
      _this.childrenViews.push(view);
...
},{"./collections/people_collection":4,"./views/person_view":7,"jquery":2,"underscore":3}],6:[function(require,module,exports){
'use strict';
...
var Person = (function (_Model) {
  ...
  _createClass(Person, [{
    ...
    key: '_getPercentage',
    value: function _getPercentage(prop) {
...
var PersonView = (function (_View) {
  function PersonView(options) {
    ...
    _get(Object.getPrototypeOf(PersonView.prototype), 'constructor', this).call(this, options);
    this.tagName = 'div';
    this.className = 'person';

    if (!options.template) {
      var text = Backbone.$('#person-template').text();
...
},{"../models/person_model.js":6,"backbone":1,"underscore":3}]},{},[5]);
